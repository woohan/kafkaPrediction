...
path = r'./recordData/msgsize-pktloss/ack1/'
...
model.save('./savedModels/mz_msgloss/ack1.h5')
# evaluate the keras model
xAxis = np.arange(100,1100,10)
yPredictions = model.predict(xAxis)[:,0]

fig1 = plt.figure()
# xAxis = trainX[:,0]
plt.plot(xAxis,yPredictions)
fig1.savefig('./figures/mz_msgloss/ack1/PredictionResult.png')
...
plt.xlabel('Epoch')
plt.ylabel('MAE')
fig2.savefig('./figures/mz_msgloss/ack1/lossHistory.png')
