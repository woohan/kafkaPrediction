...
history = model.fit(trainX, trainY, validation_split=0.25, epochs=8000, batch_size=10)
model.save('./savedModels/'+modelTitle+'/ack0.h5')
# evaluate the keras model

xAxis = np.arange(0,0.1,0.01)
